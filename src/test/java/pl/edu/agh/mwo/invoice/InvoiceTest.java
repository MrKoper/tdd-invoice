...
public class InvoiceTest {
	...
	public void testEmptyInvoiceHasEmptySubtotal() {
		Assert.assertThat(BigDecimal.ZERO, Matchers.comparesEqualTo(invoice.getTotalNetName()));
	}
	...
	public void testInvoiceHasTheSameSubtotalAndTotalIfTaxIsZero() {
		...
		Assert.assertThat(invoice.getTotal(), Matchers.comparesEqualTo(invoice.getTotalNetName()));
	}
	...
	public void testInvoiceHasProperSubtotalForManyProducts() {
		...
		Assert.assertThat(new BigDecimal("310"), Matchers.comparesEqualTo(invoice.getTotalNetName()));
	}
	...
	public void testInvoiceHasPropoerSubtotalWithQuantityMoreThanOne() {
		...
		Assert.assertThat(new BigDecimal("50"), Matchers.comparesEqualTo(invoice.getTotalNetName()));
	}
